...
Só um pequeno projeto que eu estou mexendo pra aprender a trabalhar com `Django`

### Como inicializar o projeto

Caso por algum motivo você queira testar o projeto localmente siga esses passos:

1. Clone o repositório com o comando `git clone https://github.com/luanwcode/todolist`
